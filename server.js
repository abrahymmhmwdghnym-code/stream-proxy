    ...
    res.type('text/html').send(`
        ...
        <body>
            <div class="container">
                ...
                <div class="section">
                    <h2>📺 البث المباشر الجديد</h2>
                    <div class="stream-card">
                        <div class="label">🔗 رابط البث:</div>
                        <div class="value" id="streamUrl">https://instreams.live/live/gr5buv1irc.m3u8?expires=1783317278&token=EIcvsMGjAAiNsLA8VF32Rw</div>
                        <button class="btn-copy" onclick="copyUrl()">📋 نسخ الرابط</button>
                    </div>
                    <div class="stream-card" style="border-color: #28a745;">
                        <div class="label">📱 رابط التشغيل عبر الوكيل:</div>
                ...
                <div class="section">
                    ...
                    <ul class="feature-list">
                        ...
                        <li>CORS متقدم</li>
                        <li>دعم خاص لـ instreams.live</li>
                    </ul>
                </div>

                <div class="section">
                    <h2>🔧 أمثلة عملية</h2>
                    <code>/api/stream?url=https://instreams.live/live/gr5buv1irc.m3u8?expires=1783317278&token=EIcvsMGjAAiNsLA8VF32Rw</code>
...
║                                                                ║
║  📺 البث الجديد:                                              ║
║     https://instreams.live/live/gr5buv1irc.m3u8              ║
║                                                                ║
║  ⚙️  الخيارات:                                               ║
║     ?url=<رابط الفيديو>                                     ║
